#
#  Be sure to run `pod spec lint HttpUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/seasonZhu/HttpUtils"
  ...
  s.source       = { :git => "https://github.com/seasonZhu/HttpUtils.git", :tag => "#{s.version}" }
